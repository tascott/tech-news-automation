...
export async function searchNewsWithOpenAIDeepResearch() {
    ...
    // TODO: First get a list of current batch of articles from the database, and make sure we don't add the same ones again. Then add the new ones to the database.
